...
def parse_array(s, _w=WHITESPACE_STR, _sep=","):
    ...
    for ch in s:
        ...
        if ch == "[":
            ...
            accumulator += ch
        whitespace_flag = False
    # Added part of the code: if started flag is True and stack is True or if sep_flag is True
    # than program raises ValueError
    if started_flag and stack or sep_flag:
        raise ValueError
